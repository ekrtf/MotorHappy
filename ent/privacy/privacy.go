...
import (
	...
	"github.com/ekrtf/MotorHappy/ent"
)
...
// The ManufacturerQueryRuleFunc type is an adapter to allow the use of ordinary
// functions as a query rule.
type ManufacturerQueryRuleFunc func(context.Context, *ent.ManufacturerQuery) error

// EvalQuery return f(ctx, q).
func (f ManufacturerQueryRuleFunc) EvalQuery(ctx context.Context, q ent.Query) error {
	if q, ok := q.(*ent.ManufacturerQuery); ok {
		return f(ctx, q)
	}
	return Denyf("ent/privacy: unexpected query type %T, expect *ent.ManufacturerQuery", q)
}

// The ManufacturerMutationRuleFunc type is an adapter to allow the use of ordinary
// functions as a mutation rule.
type ManufacturerMutationRuleFunc func(context.Context, *ent.ManufacturerMutation) error

// EvalMutation calls f(ctx, m).
func (f ManufacturerMutationRuleFunc) EvalMutation(ctx context.Context, m ent.Mutation) error {
	if m, ok := m.(*ent.ManufacturerMutation); ok {
		return f(ctx, m)
	}
	return Denyf("ent/privacy: unexpected mutation type %T, expect *ent.ManufacturerMutation", m)
}
